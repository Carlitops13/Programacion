/*
5)	Realizar un programa que solicite el password a un usuario, 
el programa termina cuando el usuario adivine el password o cuando se cumplan los tres intentos.
*/
#include <iostream>
